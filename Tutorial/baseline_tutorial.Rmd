...
```{r, comment = NA}
# Histograms
hist(forced[forced>=0], main = "Prevalence of Sexual Assault among all Girls", xlab = "Number of times")
hist(forced[forced>0], main = "Girls who were Sexually Assaulted at least Once", xlab = "Number of times")
...
cat("Among all girls who were sexually assaulted,", prop_once, "were sexually assaulted once.")
```

\begin{itemize}
\item Exercise: can you find the Wald intervals for prevalence of sexual assault, for just treatment schools? Just control schools?
\end{itemize}
...
cat("We observed a proportion of", prop_forced, "girls who were sexually assaulted.")
...
```{r}
# Prevalence of sexual assault among all girls (stratified)
...
hist(forced_trt[forced_trt>=0], main = "Prevalence of Sexual Assault among all Girls", xlab = "Number of rapes", col=rgb(1,0,0,0.5))
